...
g++ -std=c++17 -Wall -c Models.cpp -o obj/Models.o

g++ obj/main.o obj/ParkingSystem.o obj/DataEncryption.o obj/InteractiveMenu.o obj/validaciones.o obj/Models.o -o parking_system.exe
echo Build complete!